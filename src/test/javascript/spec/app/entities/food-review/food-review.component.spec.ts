...
import { FoodReviewComponent } from 'app/entities/food-review/food-review.component';
...
describe('Component Tests', () => {
    describe('FoodReview Management Component', () => {
        let comp: FoodReviewComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FoodReviewComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.foodReviews[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
